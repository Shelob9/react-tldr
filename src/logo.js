...
// forward //
const forward = ['M 16 0', 'L 48 0', 'L 32 32', 'L 0 32', 'z'].join(' ');

// \\
const backward = ['M 0 0', 'L 32 0', 'L 48 32', 'L 16 32', 'z'].join(' ');

export default ({ size = 256, color = '#fff', bg = '#0d0' }) => (
	<svg viewBox="0 0 160 160" width={size} height={size}>
		<circle fill={bg} cx="80" cy="80" r="80" />
